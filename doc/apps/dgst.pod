...
To sign a file using SHA-256 with binary file output:
 gmssl dgst -sha256 -sign privatekey.pem -out signature.sign file.txt

To verify a signature:
 gmssl dgst -sha256 -verify publickey.pem \
...
The default digest was changed from MD5 to SHA256 in GmSSL 1.1.0
The FIPS-related options were removed in GmSSL 1.1.0
