...
static ERR_STRING_DATA EC_str_functs[] = {
    ...
    {ERR_FUNC(EC_F_PKEY_EC_CLEANUP), "pkey_ec_cleanup"},
    {ERR_FUNC(EC_F_PKEY_EC_COPY), "pkey_ec_copy"},
    ...
    {ERR_FUNC(EC_F_PKEY_EC_VERIFY), "pkey_ec_verify"},
...
static ERR_STRING_DATA EC_str_reasons[] = {
    ...
    {ERR_REASON(EC_R_SET_SM2_ID_DIGEST_FAILED), "set sm2 id digest failed"},
    {ERR_REASON(EC_R_SET_SM2_ID_FAILED), "set sm2 id failed"},
